                ...
                <div className="flex flex-col gap-10">
                    <div className="flex flex-col gap-6">
                        <div className="flex justify-between items-center gap-6">
                            <h2 className="text-[115px] leading-none font-montserrat font-semibold"><span className="text-slate-500">Leading</span> the way</h2>
                            <p className="text-sm text-neutral-600 font-openSans font-semibold max-w-64 pt-6">{ data.des_one }</p>
                        </div>
                        <div className="flex justify-between items-center gap-6">
                            <div className="flex gap-3 border border-black/15 rounded-3xl p-4 mt-2">
                                ...
                                <Link href="#about">
                                    <div className="size-20 flex items-center justify-center border-2 bg-accent-mint border-accent-mint text-white hover:bg-white hover:text-accent-mint duration-200 rounded-full">
                                        <FaArrowRight className="size-6 rotate-45"/>
                                    </div>
                                </Link>
                            </div>
                            <h2 className="text-[115px] leading-none font-montserrat font-semibold">logistics <span className="text-accent-mint">solutions</span></h2>
                        </div>
                    </div>
